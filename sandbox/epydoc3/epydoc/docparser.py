...
class DocParser:
    ...
    #////////////////////////////////////////////////////////////
    # Parse Handler: Tuple Assignments
    #////////////////////////////////////////////////////////////
    # E.g.: (x,y)=1 or [x,y]=1
    ...
    def process_funcdef(self, comments, funcname, parameters,
    ...
    def process_classdef(self, comments, classname,
    ...
    def process_multistmt(self, vars, pseudo_docstring):
        ...
        Parse a set of semicolon-separated statements, such as:
            >>> x=1; y=2; z=3
        C{process_multistmt} simply wraps the statements in a suite,
        and delegates to C{process_suite}.
        """
